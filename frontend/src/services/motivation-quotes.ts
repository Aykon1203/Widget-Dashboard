// Generated by scripts/generate-motivation-quotes.cjs — do not edit
export default [
  {
  ...
  {
    "text": "In my experience, there is only one motivation, and that is desire. No reasons or principle contain it or stand against it.",
    "author": "Jane Smiley"
  },
  {
  ...
  {
    "text": "You may only succeed if you desire succeeding; you may only fail if you do not mind failing.",
    "author": "Philippos"
  },
  {
  ...
  {
    "text": "Successful people do what unsuccessful people are not willing to doDon't wish it were easier, wish you were better.",
    "author": "Jim Rohn"
  },
  {
  ...
  {
    "text": "Good things come to people who wait, but better things come to those who go out and get them.",
    "author": "Anonymous"
  },
  {
  ...
  {
    "text": "No masterpiece was ever created by a lazy artist",
    "author": " Anonymous"
  },
  {
  ...
  {
    "text": "Courage is resistance to fear, mastery of fear - not absense of fear",
    "author": "Mark Twain"
  },
  {
  ...
  {
    "text": "I don't want to get to the end of my life and find that I lived just the length of it. I want to have lived the width of it as well",
  ...
  {
    "text": "Happiness is a butterfly, which when pursued, is always beyond your grasp, but which, if you will sit down quietly, may alight upon you.",
  ...
  {
    "text": "There is no chance, no destiny, no fate, that can hinder or control the firm resolve of a determined soul.",
  ...
  {
    "text": "Little minds are tamed and subdued by misfortune; but great minds rise above it.",
  ...
  {
    "text": "The reason most people never reach their goals is that they don't define them, or ever seriously consider them as believable or achievable. Winners can tell you where they are going, what they plan to do along the way, and who will be sharing the adventure with them.",
  ...
  {
    "text": "Most of the important things in the world have been accomplished by people who have kept on trying when there seemed to be no help at all.",
    "author": "Dale Carnegie"
  },
  {
  ...
  {
    "text": "Your problem isn't the problem. Your reaction is the problem.",
    "author": "Anonymous"
  },
  {
  ...
  {
    "text": "If you want to make a permanent change, stop focusing on the size of your problems and start focusing on the size of you!",
    "author": "T. Harv Eker"
  },
  {
  ...
  {
    "text": "The best reason to start an organization is to make meaning; to create a product or service to make the world a better place.",
    "author": "Guy Kawasaki"
  },
  {
